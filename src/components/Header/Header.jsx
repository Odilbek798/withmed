    ...
    <header className={s.header}>
        ...
        <nav className={s.nav}>
            ...
            <div className={`${s.menu} ${isActive ? s.active : null}`}>
                ...
                <Link onClick={closeMenu}  to={'/shop'} className={s.dropdown}>Shop
                </Link>
                <svg
                  width="16"
                  height="16"
                ...
                <div>
                    <Link onClick={closeMenu} to={'/'}>Casual</Link>
                    <Link onClick={closeMenu} to={'/'}>Formal</Link>
                    <Link onClick={closeMenu} to={'/'}>Party</Link>
                    <Link onClick={closeMenu} to={'/'}>Gym</Link>
